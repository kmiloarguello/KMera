...
var _main = require('../km-api-client/main.js');

var _main2 = require('../render/main.js');

var _main3 = _interopRequireDefault(_main2);

var _main4 = require('../km-container/main.js');

var _main5 = _interopRequireDefault(_main4);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _page2.default)('/', function (ctx, next) {
  if (!localStorage.shows) {
    (0, _main.getShows)(function () {
      _main5.default.find('.loader').remove();
      localStorage.shows = JSON.stringify(shows);
      (0, _main3.default)(shows);
    });
  } else {
    (0, _main3.default)(JSON.parse(localStorage.shows));
  }
}); /**
    * Module Dependencies
    **/
...
},{"../km-api-client/main.js":7,"../km-container/main.js":8,"../render/main.js":9,"jquery":1,"page":2}],7:[function(require,module,exports){
'use strict';
...
exports.default = (0, _jquery2.default)('#app-body').find('.main-djs'); /**
                                                                        * Module Dependencies
                                                                        **/
...
var _main = require('../km-container/main.js');
...
function renderShows(shows) {
  _main2.default.find('.loader').remove();
  shows.forEach(function (show) {
    ...
    $article.hide();
    _main2.default.append($article.fadeIn(1500));
  });
}

},{"../km-container/main.js":8,"jquery":1}]},{},[6]);
